...
from PySide6.QtWidgets import QWidget, QScrollArea, QGridLayout, QVBoxLayout, QPushButton, QButtonGroup
...
class SnippetInsert(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.container.setStyleSheet("QPushButton { font-size: 16px; background-color: #fafff5; border: 1px solid #003; margin: 1px; padding: 1px; }")
